...
class ConclusionChain(BaseModel):
    ...
    def lock(self, stage: str, content: dict[str, Any]) -> LockedConclusion:
    ...
    def get_locked_context(self, current_stage: str) -> str:
    ...
    def check_consistency(self, new_output: dict[str, Any], current_stage: str) -> ConsistencyResult:
        """检查新输出是否与已锁定结论矛盾
            ...
            if clarify_content:
                ...
                if topic:
                    ...
                    if topic_keywords:
                        ...
                        for text in self._extract_strings(new_output):
    ...
    def get_chain_summary(self) -> dict[str, Any]:
        ...
        return {
            ...
            "locked_stages": [c.stage for c in self.conclusions],
    ...
    def _extract_strings(obj: Any) -> list[str]:
        ...
        if isinstance(obj, str):
            ...
            for value in obj.values():
                result.extend(ConclusionChain._extract_strings(value))
        elif isinstance(obj, list):
            for item in obj:
                result.extend(ConclusionChain._extract_strings(item))
        return result
