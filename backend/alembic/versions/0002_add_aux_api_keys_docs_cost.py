...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "value_json", sa.Text, nullable=False, server_default="{}", comment="JSON-serialized aux field value"
        ),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(100), nullable=False, server_default="default", comment="Key别名"),
        sa.Column("encrypted_key", sa.Text, nullable=False, comment="Fernet加密存储的API Key"),
    ...
    op.create_table(
        ...
        sa.Column(
            "meeting_id", sa.String(36), sa.ForeignKey("meetings.id", ondelete="CASCADE"), nullable=False, index=True
        ),
        ...
        sa.Column(
            "content_hash", sa.String(64), nullable=False, server_default="", comment="SHA256 of file content for dedup"
        ),
        sa.Column("created_at", sa.DateTime(timezone=True), nullable=False, server_default=sa.func.now()),
    )
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer, primary_key=True, autoincrement=True),
        sa.Column(
            "meeting_id", sa.String(36), sa.ForeignKey("meetings.id", ondelete="SET NULL"), nullable=True, index=True
        ),
        sa.Column("stage", sa.String(30), nullable=False, server_default=""),
        sa.Column("node", sa.String(50), nullable=False, server_default="", comment="调用节点: llm|tool|sandbox"),
